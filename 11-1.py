...
for r in range(20):
    for m in range(8):
        for i in items[m]:
            if m == 0:
                i = (i * 13)//3
                if i % 5 == 0: items[1].append(i)
                else:          items[6].append(i)
            elif m == 1:
                i = (i + 3)//3
                if i % 7 == 0: items[5].append(i)
                else:          items[3].append(i)
            elif m == 2:
                i = (i * i)//3
                if i % 13 == 0: items[0].append(i)
                else:           items[6].append(i)
            elif m == 3:
                i = (i + 5)//3
                if i % 11 == 0: items[5].append(i)
                else:           items[7].append(i)
            elif m == 4:
                i = (i + 7)//3
                if i % 3 == 0: items[2].append(i)
                else:          items[0].append(i)
            elif m == 5:
                i = (i + 4)//3
                if i % 2 == 0: items[4].append(i)
                else:          items[7].append(i)
            elif m == 6:
                i = (i * 19)//3
                if i % 17 == 0: items[1].append(i)
                else:           items[3].append(i)
            elif m == 7:
                i = (i + 2)//3
                if i % 19 == 0: items[2].append(i)
                else:           items[4].append(i)
